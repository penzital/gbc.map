	...
	*/
	...
	$.fn.wayfinding = function (action, options) {
		...
		function cleanupSVG(target, el) {
			...
			/** MODIFIED BY TODARO C. **/
			/** Di default ad un evento di "doppio click" corrispondono due eventi di click e ciň causa l'evento di zoom e contemporaneamente
...
//                              maps[level[0].floor].svgHandle.circle(stroke.x,stroke.y,2);
						...
						/** MODIFIED BY TODARO C. **/
						/** Modificato affinchč l'inserimento del best path avvenga all'interno dell'elemento <g>
							che raggruppa tutti gli elementi della mappa su cui fare lo zoom (ciň permette che lo zoom della mappa
